...
export default function Modal({ delModalShow, onClose, id, deletedAssign }) {
    ...
    function deleteAssign() {
        axios
            ...
            .then(res => {
                Swal.fire({
                    title: 'Success',
                    text: 'Assign Task is deleted successfully!',
                    icon: 'success',
                    ...
                    <div className="text-start">
                        <div className="p-5">
                            <p className="font-bold text-xl my-3">
                                You are about to delete your Assign Task.
                            </p>
                            <p>
                                Are you going to really delete your Assign Task?
