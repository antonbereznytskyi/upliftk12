...
export default function viewAllLessons({ onBack, onClose }) {
    return (
        <div className="w-full h-full bg-gradient-to-b from-white to-sky-100 rounded-lg font-poppins text-center pt-10 xl:pt-12 xl:px-20 px-2 sm:px-5 md:px-10">
            <p className="text-2xl font-bold text-sky-900 sm:text-4xl mb-5 xl:text-5xl xl:mb-5">
                View All of Our Games
            </p>
            <div className=" md:grid md:grid-cols-2 md:gap-2 rounded-lg bg-sky-200 text-start mr-1 mt-2 h-4/5 xl:h-4/5 font-poppins p-2 pr-7 scrollbar-thin scrollbar-thumb-sky-500 scrollbar-track-white overflow-y-scroll scrollbar-thumb-rounded-full scrollbar-track-rounded-full scroll-p-2">
