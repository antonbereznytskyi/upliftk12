...
import ClassDataTable from '../components/Tables/ClassDataTable'
import DelClassModal from '../components/modal/DelClassModal'
...
const MyClass = () => {
    ...
    return (
        <div>
            <AppLayout title="My Class">
                <Head>
                    <title>My Class</title>
                </Head>
                <div className="py-2 px-11 bg-gray-100 h-full">
                    <div className="container mx-auto">
                        <div className="flex justify-center mt-7">
                            <ClassDataTable
                                url="/api/classes/show"
                                reload={reload}
                                onReload={() => {
                                    setReload(false)
                                }}
