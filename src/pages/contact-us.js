...
export default function(){
    ...
    return (
        <LandingLayout>
            ...
            <div>
                <p className='text-center lg:text-5xl sm:text-3xl text-2xl font-medium text-[#1d3f54] font-poppins mt-16'>Get in Touch</p>
                <img src='/images/contactus/image1.png' className='mb-10 w-full'/>
                <div className='block mx-auto w-[530px] sm:pl-[30px]' id='hubSpotForm'>
                    <HubspotForm
                        portalId="23386388"
                        formId="ba679571-df11-45eb-87dc-f42e8cb50857"
                        ...
                        onReady={() => {
                            ...
                            if(src.length === 0) {
                                let el = document.getElementById('hubSpotForm')
